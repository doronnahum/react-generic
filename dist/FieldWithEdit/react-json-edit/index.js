...
(function webpackUniversalModuleDefinition(root, factory) {
	if (typeof exports === 'object' && typeof module === 'object') module.exports = factory(require("react"));else if (typeof define === 'function' && define.amd) define(["react"], factory);else if (typeof exports === 'object') exports["react-json-edit"] = factory(require("react"));else root["react-json-edit"] = factory(root["React"]);
       ...
       */
				...
				_createClass(AddButton, [{
					...
					value: function input() {
						...
						return _react2['default'].createElement('div', { className: 'AddButton', style: this.getStyle() }, inputs, _react2['default'].createElement('button', { className: 'save-button', style: this.getButtonStyle('save-button'), onClick: this.save }, 'Save'), _react2['default'].createElement('button', { className: 'cancel-button', style: this.getButtonStyle('cancel-button'), onClick: this.cancel }, 'Cancel'));
					}
				}, {
					key: 'render',
					value: function render() {
						if (this.state.adding) {
							...
							return _react2['default'].createElement('button', { className: 'add-button', style: this.getButtonStyle('add-button'), onClick: this.add }, '+');
						}
					}
				}]);
			...
			var AddInput = (function (_Component) {
				...
				_createClass(AddInput, [{
					...
					value: function select() {
						...
						return _react2['default'].createElement('select', { onChange: this.handleSelectChange,
							defaultValue: this.state.type }, input);
					}
				}, {
					key: 'input',
					value: function input() {
					...
					value: function doneButton() {
						return _react2['default'].createElement('button', { className: 'add-button', style: this.getButtonStyle(), onClick: this.onDone }, '√');
					}
				}, {
					key: 'getStyle',
					value: function getStyle() {
					...
					value: function render() {
						...
						return _react2['default'].createElement('div', { className: 'AddInput' }, multiple && this.select(), this.state.show ? this.input() : this.doneButton());
					}
				}]);
			...
			var ValueItem = (function (_Component) {
				...
				_createClass(ValueItem, [{
					...
					value: function renderInnerValue() {
						return _react2['default'].createElement('span', null, this.value(), this.context.setup.tableLike ? null : this.getSuffix());
					}
				}, {
					key: 'renderValue',
					value: function renderValue() {
						return _react2['default'].createElement('div', { className: this.getClassName(), style: this.getStyle(), onClick: this.activateEdit,
							onMouseOver: this.mouseOver, onMouseOut: this.mouseOut }, this.renderInnerValue(), this.renderDelete());
					}
				}, {
					key: 'renderDelete',
					value: function renderDelete() {
						...
						return _react2['default'].createElement('button', { className: 'delete-button', onClick: this.onDelete, style: style }, '⌫');
					}
				}, {
					key: 'render',
					value: function render() {
				...
				_createClass(ArrayItem, [{
					...
					value: function render() {
						...
						var items = this.props.doc.map(function (item, index) {
							...
							return _react2['default'].createElement('div', { className: 'ArrayRow', style: this.getRowStyle() }, (0, _Helpers.render_item)(key, index, item, this.propagateChanges, index == lastIndex));
						}, this);

						return _react2['default'].createElement('div', { className: 'ArrayItem', style: this.getStyle() }, this.context.setup.tableLike ? null : '[', items, _react2['default'].createElement('div', { className: 'ArrayRow', style: this.getRowStyle() }, _react2['default'].createElement(_AddButton2['default'], { onDone: this.addItem, setup: this.addButtonSetup() })), this.context.setup.tableLike ? null : ']');
					}
				}]);
			...
			var JsonEditor = (function (_Component) {
				...
				_createClass(JsonEditor, [{
					...
					value: function render() {
						...
						return _react2['default'].createElement('div', { className: 'JsonEditor', style: this.getStyle() }, children);
					}
				}]);
				...
				_createClass(ObjectItem, [{
					...
					value: function render() {
						...
						var rows = keys.map(function (jkey, i) {
							...
							return _react2['default'].createElement('div', { key: this.props.jkey + '.r' + i, className: 'ObjectRow', style: this.getRowStyle() }, _react2['default'].createElement(_KeyItem2['default'], { key: this.props.jkey + '.k' + i, jkey: jkey, propagateKeyChange: this.propagateKeyChange }), (0, _Helpers.render_item)(this.props.jkey + '.' + jkey + i, jkey, this.props.doc[jkey], this.propagateChanges, isLast));
						}, this);

						return _react2['default'].createElement('div', { className: 'ObjectItem', style: this.getStyle() }, this.context.setup.tableLike ? null : '{', rows, _react2['default'].createElement(_AddButton2['default'], { onDone: this.addItem, setup: this.addButtonSetup() }), this.context.setup.tableLike ? null : '}');
					}
				}]);
